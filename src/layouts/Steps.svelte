...
<section id="steps" class="mx-auto flex w-full flex-col items-center overflow-x-hidden py-12 md:py-16">
	...
	<div class="relative flex flex-row items-center gap-4">
		<button aria-label="Previous step" class="stepsSlider-button-prev">
			<img class="rotate-180" src="/assets/arrow_nav.svg" alt="Previous step" width="24" height="24" draggable="false" />
		</button>
		<span class="stepsSlider-pagination w-12 text-center text-base text-slate-500"></span>
		<button aria-label="Next step" class="stepsSlider-button-next">
			<img src="/assets/arrow_nav.svg" alt="Next step" width="24" height="24" draggable="false" />
		</button>
	</div>
</section>
